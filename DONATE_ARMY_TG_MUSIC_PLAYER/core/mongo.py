...
if config.MONGO_DB_URI is None:
    LOGGER(__name__).warning(
        "𝐍o 𝐌ONGO 𝐃B 𝐔RL 𝐅ound.. 𝐘our 𝐁ot 𝐖ill 𝐖ork 𝐎n 𝐃𝐎𝐍𝐀𝐓𝐄_𝐀𝐑𝐌𝐘™ 𝐃atabase"
    )
    temp_client = Client(
    ...
    mongodb = _mongo_async_.DONATE_ARMY_TG_MUSIC_PLAYER
    pymongodb = _mongo_sync_.DONATE_ARMY_TG_MUSIC_PLAYER
