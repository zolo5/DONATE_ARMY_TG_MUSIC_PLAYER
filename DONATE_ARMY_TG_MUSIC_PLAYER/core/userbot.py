    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("DONATE_ARMY_BOTS")
                await self.one.join_chat("DONATE_ARMY_BOTS_SUPPORT_CHAT")
            except:
                pass
            assistants.append(1)
