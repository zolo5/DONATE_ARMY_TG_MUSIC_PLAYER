...
from DONATE_ARMY_TG_MUSIC_PLAYER import Carbon, app
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.decorators.language import language, languageCB
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from DONATE_ARMY_TG_MUSIC_PLAYER import YouTube
...
@app.on_callback_query(filters.regex("DONATE_ARMY_playlist") & ~BANNED_USERS)
@languageCB
