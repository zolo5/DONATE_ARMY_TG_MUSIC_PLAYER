...
from DONATE_ARMY_TG_MUSIC_PLAYER.utils import bot_sys_stats
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.decorators.language import language
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.inline import support_group_markup
...
async def ping_com(client, message: Message, _):
    ...
    start = datetime.now()
    pytgping = await DONATE_ARMY.ping()
