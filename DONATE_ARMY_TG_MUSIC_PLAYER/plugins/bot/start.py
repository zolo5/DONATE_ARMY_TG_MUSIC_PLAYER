...
from DONATE_ARMY_TG_MUSIC_PLAYER.plugins.sudo.sudoers import sudoers_list
...
"""
        ...
        try:
            ...
            donate = await message.reply_text(f"**ᴅιиg ᴅσиg ꨄ︎❣️.....**")
            await donate.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.❣️....**")
            await donate.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎..❣️...**")
            await donate.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎...❣️..**")
            await donate.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎....❣️.**")
            await donate.edit_text(f"**ᴅιиg ᴅσиg ꨄ︎.....❣️**")
            ...
            await donate.delete()
            donate_army = await message.reply_text("**⚡ѕ**")
            await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕт**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтα**")
            #  await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαя**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαят**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαятι**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαятιи**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαятιиg**")
            # await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαятιиg.**")
            await asyncio.sleep(0.1)
            await donate_army.edit_text("**⚡ѕтαятιиg....**")
