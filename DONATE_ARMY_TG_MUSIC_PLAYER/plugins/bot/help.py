...
donate = "https://graph.org/file/fbcc2ed685a503973cbfc-d553cf81e8013d78c2.jpg"
...
async def music_callback(client: Client, callback_query: CallbackQuery):
    ...
    await callback_query.message.edit(
        f"``**Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ ғᴏʀ ᴍᴏʀᴇ ɪɴғᴏʀᴍᴀᴛɪᴏɴ.  Iғ ʏᴏᴜ'ʀᴇ ғᴀᴄɪɴɢ ᴀɴʏ ᴘʀᴏʙʟᴇᴍ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ɪɴ [sᴜᴘᴘᴏʀᴛ ᴄʜᴀᴛ.](https://t.me/DONATE_ARMY_BOTS_SUPPORT_CHAT)**\n\n**Aʟʟ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ: /**``",
        reply_markup=keyboard,
    )
...
async def back_button_callback(client: Client, callback_query: CallbackQuery):
    keyboard = [
        [
            ...
            InlineKeyboardButton(
                text="🌱ɢɪᴛʜᴜʙ🌱",
                url="https://github.com/DONATE-ARMY-BOTS",
            ),
        ],
        [
