...
from DONATE_ARMY_TG_MUSIC_PLAYER.utils import AdminRightsCheck
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.database import is_active_chat, is_nonadmin_chat
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.decorators.language import languageCB
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, callback_query, _):
    ...
    try:
        await DONATE_ARMY.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
