...
from DONATE_ARMY_TG_MUSIC_PLAYER.utils.formatters import time_to_seconds
...
def stream_markup_timerr(_, videoid, chat_id, played, dur):
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ", callback_data=f"DONATE_ARMY_playlist {videoid}"
            ),
            InlineKeyboardButton(
                text="ᴄᴏɴᴛʀᴏʟs ♻",
...
def playlist_markupp(_, videoid, user_id, ptype, channel, fplay):
    buttons = [
        [
            InlineKeyboardButton(
                text=_["P_B_1"],
                callback_data=f"DONATE_ARMY_Playlists {videoid}|{user_id}|{ptype}|a|{channel}|{fplay}",
            ),
            InlineKeyboardButton(
                text=_["P_B_2"],
                callback_data=f"DONATE_ARMY_Playlists {videoid}|{user_id}|{ptype}|v|{channel}|{fplay}",
            ),
        ],
        [
            InlineKeyboardButton(
...
# =======================================================DONATE-ARMY-BOTS-MUSIC-PLAY-BUTTONS========================================
...
def panel_markup_clone(_, vidid, chat_id):
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="✚ ᴘʟᴀʏʟɪsᴛ ✚", callback_data=f"DONATE_ARMY_playlist {vidid}"
            ),
        ],
    ]
