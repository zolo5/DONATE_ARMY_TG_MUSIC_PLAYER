...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/DONATE-ARMY-BOTS/DONATE_ARMY_MUSIC_PLUGIN",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5347809540").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/DONATE-ARMY-BOTS/DONATE_ARMY_TG_MUSIC_PLAYER",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/DONATE_ARMY_BOTS"
)  # Example:- https://t.me/DONATE_ARMY_BOTS
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/DONATE_ARMY_BOTS_SUPPORT_CHAT"
)  # Example:- https://t.me/DONATE_ARMY_BOTS_SUPPORT_CHAT
...
VIDEO_STREAM_LIMIT = int(getenv("VIDEO_STREAM_LIMIT", "50000"))
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @DONATE_ARMY_STRING_SESSION_BOT
...
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "DONATE_ARMY_LOGS.txt"
...
START_IMG_URL = getenv(
    "START_IMG_URL",
    "https://graph.org/file/daa67cfef27574c39b163-3f5d0a45d32e49dd79.jpg",
)
