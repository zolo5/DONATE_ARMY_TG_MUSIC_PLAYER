# DONATE_ARMY_TG_MUSIC_PLAYER BOT Configs
...
- These are the minimum required vars need to setup to make DONATE_ARMY_TG_MUSIC_PLAYER BOT functional.
...
7. `STRING_SESSION` : Pyrogram Session Needed, Generate string from [@DONATE_ARMY_STRING_SESSION_BOT](http://t.me/DONATE_ARMY_STRING_SESSION_BOT) in Telegram.
...
- You can play tracks or playlists from spotify from DONATE_ARMY_TG_MUSIC_PLAYER BOT
...
- If you plan to use DONATE_ARMY_TG_MUSIC_PLAYER BOT with your own customized or modified code.
...
- You can change images which are used in DONATE_ARMY_TG_MUSIC_PLAYER BOT.
- You can generate telegaph links from [@DONATE_ARMY_TELEGRAPH_BOT](http://t.me/DONATE_ARMY_TELEGRAPH_BOT) and use it here.
...
1. `STRING_SESSION2` : Pyrogram Session Needed, Generate string from [@DONATE_ARMY_STRING_SESSION_BOT](http://t.me/DONATE_ARMY_STRING_SESSION_BOT) in Telegram.
2. `STRING_SESSION3` : Pyrogram Session Needed, Generate string from [@DONATE_ARMY_STRING_SESSION_BOT](http://t.me/DONATE_ARMY_STRING_SESSION_BOT) in Telegram.
3. `STRING_SESSION4` : Pyrogram Session Needed, Generate string from [@DONATE_ARMY_STRING_SESSION_BOT](http://t.me/DONATE_ARMY_STRING_SESSION_BOT) in Telegram.
4. `STRING_SESSION5` : Pyrogram Session Needed, Generate string from [@DONATE_ARMY_STRING_SESSION_BOT](http://t.me/DONATE_ARMY_STRING_SESSION_BOT) in Telegram.
